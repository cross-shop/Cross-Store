      ...
      <main className="negr container">
        <div className="negr-1">
          ...
          <div className="negr1-img">
            <img src={kros5} alt="" />
            <p>
              В 2009 году Канье Уэст и его друг, стилист и давний партнер
              Вирджил Абло <br /> отправляются в Париж, где вместе проходят
              стажировку в модном доме Fendi. <br /> Уэст выходит на новый
              уровень и представляет кроссовки, разработанные вместе <br /> с
              культовым модным домом Louis Vuitton. Под эгидой совместного
              проекта в 2009 <br /> году в продажу поступают сразу три модели.
              Тогда же выходят первые Nike Air <br /> Yeezy и вокруг персоны
              Уэста, как сникер-дизайнера, образуется ажиотаж.
            </p>
          </div>
          ...
          <div className="negr2-img2">
            ...
            <div className="negr2-img2-p2">
              <img src={kros5} alt="" />
              <p>
                В 2009 году Канье Уэст и его друг, <br /> стилист и давний
                партнер Вирджил <br /> Абло отправляются в Париж, где <br />{" "}
                вместе проходят стажировку в <br /> модном доме Fendi. Уэст
                выходит <br /> на новый уровень и представляет <br /> кроссовки,
                разработанные вместе с <br /> культовым модным домом Louis{" "}
                <br /> Vuitton. Под эгидой совместного <br /> проекта в 2009
                году в продажу <br /> поступают сразу три модели.{" "}
              </p>
            </div>
          </div>
          ...
          <div className="negr-1-2">
            ...
            <p>
              ...
              Вирджил Абло <br /> отправляются в Париж, где вместе проходят
              стажировку в модном доме Fendi. <br /> Уэст выходит на новый
              уровень и представляет кроссовки, разработанные <br /> вместе с
              культовым модным домом Louis Vuitton. Под эгидой совместного{" "}
              <br /> проекта в 2009 году в продажу поступают сразу три модели.
              Тогда же выходят <br /> первые Nike Air Yeezy и вокруг персоны
              Уэста, как сникер-дизайнера, образуется <br /> ажиотаж.
            </p>
          </div>
